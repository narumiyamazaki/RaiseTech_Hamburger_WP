<?php get_header();?>
                    ...
                    <main class="l-main__archive">
                        ...
                        <article class="p-article__archive">
                            ...
                            <?php 
                            //Map型の配列
                            //ページナビゲーションプラグインを使うための記述
                            //三項演算子　変数 = (判定) ? 正の場合 : 偽の場合;
                            //$paged は　get_query_var('paged')なら、get_query_var('paged') そうでなければ1（取得できない場合を想定？）
                            $paged =  get_query_var( 'paged' ) ? get_query_var( 'paged' ) : 1;
                            $cat_now = get_queried_object();
                            $args = array(
                                'cat' => $cat_now->cat_ID,// カテゴリーIDを自動取得
                            ...
                            <div <?php post_class ('p-article__archive--wrapper'); ?>>
